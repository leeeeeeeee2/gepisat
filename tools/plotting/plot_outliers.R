...
out.file.path <- paste("/home/user/Projects/gepisat/results/2002-06/",
                       "attempt22b/outliers/",
                       sep = "")
obs.station.dir <- paste("/home/user/Projects/gepisat/results/2002-06/",
                         "attempt22b/partitioning/obs/",
                         sep = "")
ro.station.dir <- paste("/home/user/Projects/gepisat/results/2002-06/",
                        "attempt21/partitioning/ro/",
                        sep = "")
...
for (st.id in stations) {
	...
	postscript(
		file = paste(out.file.path, ps.file.name.l, sep = ""),
		width = 6,
		height = 6,
		paper = "special",
		horizontal = FALSE,
